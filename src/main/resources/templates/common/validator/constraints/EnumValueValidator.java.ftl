 ...
 * @author ${author}
 */
public class EnumValueValidator implements ConstraintValidator${r'<'}EnumValue, Object> {
    /**
     * 枚举类对象
     */
    private Class${r'<'}? extends Enum${r'<'}?>> enumClass;
    /**
     * 枚举校验的方法
     */
    ...
    public boolean isValid(Object value, ConstraintValidatorContext constraintValidatorContext) {
        ...
        Class${r'<'}?> valueClass = value.getClass();
        try {
